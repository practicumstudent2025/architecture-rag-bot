...
- **Размер индекса**: ~72 MB (chroma.sqlite3)

Детальная информация сохранена в `index_info.json`

## Примеры запросов

См. файл `test_results.json` для примеров поисковых запросов и найденных чанков.
